...
#     exit()
    ...
    # cropped_pil = Image.fromarray(cv2.cvtColor(cropped_copy, cv2.COLOR_GRAY2RGB))

    # draw = ImageDraw.Draw(cropped_pil)

    # try:
    #     font = ImageFont.truetype("arialbd.ttf", 20)  # You can change font path if needed
    # except:
    ...
    #     draw.text((center_x - w/2, center_y - h/2), note, fill=(255, 255, 255), font=font)
